...
import { useDeleteVideoTestimonialMutation, useGetAllVideoTestimonialQuery } from "../redux/features/videoTestimonialEndPoint";

export default function VideoTestimonialsDataTable() {
                    ...
                    <>
                        <div className="d-flex gap-1">
                            <OverlayTrigger key="bottom" placement="bottom" overlay={<Tooltip id="tooltip-bottom">Edit</Tooltip>}>
                                <Link to={`/view-video-textomonial/${row?.id}`}>
                            ...
                            <OverlayTrigger key="bottom" placement="bottom" overlay={<Tooltip id="tooltip-bottom">Edit</Tooltip>}>
                                <Link to={`/edit-video-textomonial/${row?.id}`}>
