...
import { useDeleteBlogCategoriesMutation, useDeleteBlogMutation, useDeleteBlogTagsMutation, useDeleteNewsMutation, useGetBlogCategoriesQuery, useGetBlogQuery, useGetBlogTagsQuery, useGetNewsQuery } from "../redux/features/companyEndPoint";
...
export default function NewsDataTable() {
    ...
    const { data, isError, error, isLoading, isFetching, isSuccess, refetch } = useGetNewsQuery();
