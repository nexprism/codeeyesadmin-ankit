...
// import { useGetAllUsersQuery, useUpdateUserMutation } from "../redux/features/AuthenticationEndPoints";
import PageHeader from "../layouts/layoutcomponents/pageheader";
import { useGetAllDeletedUsersQuery } from "../redux/features/AuthenticationEndPoints";

export default function DeletedUserDataTable() {
    ...
    const { data, isError, error, isLoading, isFetching, isSuccess } =
        useGetAllDeletedUsersQuery(queryParams);
        ...
        return (
            <>
                <Row className="align-items-center">
                    <Col> <PageHeader titles="User" active="Deleted User List" items={["Home"]} links={['/dashboard']} /> </Col>
