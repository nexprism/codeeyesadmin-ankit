...
import { useGetAllOurTeamQuery, useDeleteOurTeamMutation } from "../redux/features/ourTeamEndPoint";
import moment from "moment";
import { Link, useLocation } from "react-router-dom";
import Cookies from 'js-cookie';

export default function TeamMemberDataTable() {
    ...
    const handleDelete = async (row) => {
        const resp = await deleteTeamMember(row);
    ...
    if (isSuccess) {
        ...
        const filteredData = postsData?.filter((item) => {
            ...
            return item?.name?.toLowerCase().includes(searchTermLower) || item?.position?.toLowerCase().includes(searchTermLower);
        });
