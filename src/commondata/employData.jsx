...
import { useDeleteBlogTagsMutation, useGetBlogTagsQuery } from "../redux/features/companyEndPoint";
...
export default function EmployDataTable() {
    ...
    const { data, isError, error, isLoading, isFetching, isSuccess, refetch } = useGetBlogTagsQuery();
                    ...
                    <>
                        <div className="d-flex gap-1">
                            ...
                            >
                                <Button
                                    variant="primary"
                                    onClick={() => { dispatch(openModal({ componentName: 'ViewEmploy', data: row?.id })) }}
                                >
                            ...
                            >
                                <Button
                                    variant="warning"
                                    onClick={() => { dispatch(openModal({ componentName: 'EditEmploy', data: row?.id })) }}
                                >
