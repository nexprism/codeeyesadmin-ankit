...
import { useAddTextTestimonialMutation, useEditTextTestimonialMutation, useGetAllTextTestimonialQuery, useGetTextTestimonialQuery } from "../../redux/features/textTestimonialEndPoingt";
import TextArea from "antd/es/input/TextArea";
import { TextTestimonialValidation } from "../../commondata/formvalidations";

export default function EditTextTestimonial() {
  const { id } = useParams()
  ...
  const [addBlog, { isLoading: loadingAdd }] = useEditTextTestimonialMutation();
  ...
  const { values, errors, handleBlur, touched, handleChange, handleSubmit, resetForm, setFieldValue, setFieldTouched, validateForm } = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        const response = await addBlog({ formData: formData, id: id });
  ...
  return (
    <>
      ...
      <Row>
        <Col>
          <PageHeader titles="Testimonial" active="Edit Text Testimonial" items={["Home"]} links={["/dashboard"]} />
        </Col>
      </Row>
      <Row>
        <Col>
